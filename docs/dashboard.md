...
The 24-hour and 7-day views show measured occupancy only. The chart inserts a break when two measurements are more than 75 minutes apart. The break prevents the chart from representing missing data as a continuous measurement.
